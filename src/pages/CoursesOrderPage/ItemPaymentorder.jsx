...
import BoxorderPay from "./BoxorderPay";

const ItemPaymentorder = () => {
  return (
    <div className="itemorder paymentorder">
      <h3 className="title --t3">Hình thức thanh toán</h3>
      <div className="boxorder">
        <BoxorderPay
          imageSrc="img/icon-payment-method-atm.svg"
          methodpay="Thành toán bằng chuyển khoản"
        ...
        />
        <BoxorderPay
          imageSrc="img/icon-payment-method-mo-mo.svg"
          methodpay="Thanh toán bằng ví Momo"
        ...
        />
        <BoxorderPay
          imageSrc="img/icon-payment-method-cod.svg"
          methodpay="Thanh toán bằng tiền mặt"
...
export default ItemPaymentorder;
